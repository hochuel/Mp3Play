...
public class MusicActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = (ArrayList<Music>) intent.getSerializableExtra("playlist");
    ...
    public void playMusic(Music musicDto) {
        ...
        try {
            ...
            Log.d("getNumberOfBands_01", "" + equalizer.getNumberOfBands());
            Log.d("getNumberOfPresets", ""+equalizer.getNumberOfPresets());

            for(int i = 0; i < equalizer.getNumberOfBands(); i++){
                //Log.d("getCenterFreq::", ""+String.valueOf(equalizer.getCenterFreq((short)i)));
                Log.d("getPresetName", equalizer.getPresetName((short)i));
                Log.d("BandFreqRange :: ", equalizer.getBandFreqRange((short)i)[0]+"~"+equalizer.getBandFreqRange((short)i)[1]);
            }
